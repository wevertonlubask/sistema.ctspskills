"""Generate evolution chart use case."""

from datetime import date
from uuid import UUID

from src.application.analytics.dtos.chart_dto import TimeSeriesDTO
...
class GenerateEvolutionChartUseCase:
    """Use case for generating grade evolution chart."""
    ...
    async def execute(
        ...
        """Generate grade evolution chart data.
        ...
        # Get evolution data
        series = await self._analytics_repository.get_grade_evolution(
